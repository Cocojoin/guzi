...
Page({
  ...
  async onLoad(options) {
    ...
    try {
      ...
      const ownerIndex = ownerOptions.indexOf(product.owner) + 1;
      const typeIndex = TYPE_OPTIONS.indexOf(product.type) >= 0 ? TYPE_OPTIONS.indexOf(product.type) : 0;
      ...
      this.setData({
        ...
        form: {
          ...
          purchaseRecord: product.purchaseRecord,
